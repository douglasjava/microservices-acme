...
@Controller
public class InstalacaoClienteApiController implements InstalacaoClienteApi {

    private static final Logger log = LoggerFactory.getLogger(InstalacaoClienteApiController.class);
    ...
    public InstalacaoClienteApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<Instalacao> buscaInstalacaoPorCpf(@ApiParam(value = "",required=true) @PathVariable("cpf") Long cpf) {
